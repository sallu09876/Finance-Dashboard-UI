...
export default function TransactionFilters({ filters, categories, onChange, onReset, activeCount }) {
  return (
    <div className="mb-4 grid grid-cols-1 gap-3 rounded-2xl border border-slate-200 bg-white p-4 md:grid-cols-2 xl:grid-cols-7 dark:border-slate-700 dark:bg-slate-800">
